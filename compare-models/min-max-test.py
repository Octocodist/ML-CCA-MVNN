...
def init_parser():
    ...
    parser.add_argument('-m','--model',  type=str, help='Choose model to train: UMNN, MVNN', choices=['UMNN','MVNN','CERT', "MMVNN","MINMAX"], default='MVNN')
...
def get_minmax(args, input_shape):
    # hard code for test
    model = MonotoneMinMax(in_features=input_shape, num_groups=minmax_parameters['num_groups'], group_size=minmax_parameters['group_size'], final_output_size=minmax_parameters['final_output_size'])
    return model

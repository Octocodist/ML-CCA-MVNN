...
if __name__ == "__main__":
    ...
    if MODEL == "MVNN":
        ...
        "parameters": {
            ...
            "lin_skip_connection": {"values": [ "False"]},
        ...
        "parameters": {
            ...
            "epochs":{ "values": [ 400]},
            "num_train_points":{ "values": [50]},
            "dropout_prob": {"values": [ 0.1]},
            #CERT Params
            "compress_non_mono": {"values": ["True"]},
    ...
    sweep_id = wandb.sweep(sweep=sweep_config, project="3 Models Testing with dev ")

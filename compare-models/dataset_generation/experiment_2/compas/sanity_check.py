...
train = pd.read_csv(filepath + "copmas-scores-raw.csv")

# prior adult convictions , number of juvenile felony, number
#of juvenile misdemeanor, and number of other convictions are monotonic features
# 13 attributes for prediction
